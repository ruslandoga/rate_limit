...
RateLimit.OrderedSetCounters.new(:sites_osc)
...
Benchee.run(
  %{
    ...
    # end,
    "set" => fn ->
      RateLimit.Counters.hit(:sites_c, _key = :rand.uniform(1000), scale, limit)
    end,
    "ordered_set" => fn ->
      RateLimit.OrderedSetCounters.hit(:sites_osc, _key = :rand.uniform(1000), scale, limit)
    end
    # "ex_rated" => fn ->
